...
#   5.2 - added support for drm_removed of key to a particular file
...
# Wrap a stream so that drm_removed gets flushed immediately
...
def usage(progname):
    ...
    print("Keys are saved to the current directory, or a specified drm_removed directory.")
